...
public class Lamp extends Activity {
	private int serviceid = Constant.LAMPID;
	private Button enter;
	private Button audioTurnOn;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        audioTurnOn = (Button)this.findViewById(R.id.audioturnon);
        audioTurnOn.setEnabled(false);
        audioTurnOn.setOnClickListener(AudioClickListener);
      
        enter.setOnClickListener(new Button.OnClickListener(){

			@Override
			public void onClick(View v) {
				Choices choice = new Choices(Constant.ENTER);
				try {
    ...
    private OnClickListener AudioClickListener = new OnClickListener() {
		...
		public void onClick(View arg0) {
			...
			intent.setClass(Lamp.this, AudioTurnOn.class);
	...
	public void setUpIbtnListeners() {
		ibtn_dropDown.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (pop == null) {
					if (adapter == null) {
						adapter = new PopupAdapter(Lamp.this);
						listView = new ListView(Lamp.this);
